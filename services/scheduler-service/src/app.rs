...
use crate::handlers::{
    create_project, delete_project, healthz, heartbeat, list_agents, list_projects, pause_project,
    portal_log, readyz, register_agent, request_task, request_task_batch, result_demo_wordcount,
    start_demo_wordcount, start_bpsw_project, start_project, status_demo_wordcount, stop_project,
    stream, submit_task, summary, sync_bpsw_scripts, update_agent_metrics, update_agent_preferences,
};
...
pub fn build_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/v1/portal/logs", post(portal_log))
